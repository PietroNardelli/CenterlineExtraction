...
{    
	...
	// convolution kernels in each direction and use them recursively.
        ...
        typedef  itk::SignedMaurerDistanceMapImageFilter< InputImageType, ImageType  > SignedMaurerDistanceMapImageFilterType;
        ...
        //distanceMapImageFilter->SetSquaredDistance(1);
	...
	typedef itk::ThresholdImageFilter< ImageType > ThresholdImageFilterType;
        ...
        thresholdFilter->ThresholdOutside(-100, 50);
        thresholdFilter->SetOutsideValue(50);
        ...
        typedef itk::PowImageFilter< ImageType, ImageType, ImageType > PowerFilterType;
   
        PowerFilterType::Pointer powerFilter = PowerFilterType::New();
        powerFilter->SetInput1(rescaleFilter->GetOutput());
        powerFilter->SetConstant2(3);*/
	...
	//gradientFilter->SetInput( gaussianFilterX->GetOutput() );
